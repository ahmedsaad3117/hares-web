...
export class UsersController {
  ...
  getProfile(@CurrentUser() user: any) {
    // Radical fix: Bypass cache for "me" profile to ensure subscription status is REAL
    return this.usersService.findOne(user.userId, false);
  }
  ...
  async forceLogout(
    ...
    await this.usersService.forceLogout(id, admin);
