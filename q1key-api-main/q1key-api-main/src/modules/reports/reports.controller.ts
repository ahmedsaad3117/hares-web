...
export class ReportsController {
    ...
    async getGeneralStats(@Query() filter: ReportFilterDto, @CurrentUser() user: any) {
    ...
    @UseGuards(RateLimiterGuard)
    @RateLimit(RATE_LIMITS.REPORTS)
    async getCashBoxReport(@Query() filter: ReportFilterDto, @CurrentUser() user: any) {
    ...
    @UseGuards(RateLimiterGuard)
    @RateLimit(RATE_LIMITS.REPORTS)
    async getCustomersReport(@Query() filter: ReportFilterDto, @CurrentUser() user: any) {
    ...
    @UseGuards(RateLimiterGuard)
    @RateLimit(RATE_LIMITS.REPORTS)
    async getLoansReport(@Query() filter: ReportFilterDto, @CurrentUser() user: any) {
    ...
    @UseGuards(RateLimiterGuard)
    @RateLimit(RATE_LIMITS.REPORTS)
    async getInstallmentsReport(@Query() filter: ReportFilterDto, @CurrentUser() user: any) {
    ...
    @UseGuards(RateLimiterGuard)
    @RateLimit(RATE_LIMITS.REPORTS)
    async getUnifiedReport(@Query() filter: ReportFilterDto, @CurrentUser() user: any) {
        try {
            if (!user) {
