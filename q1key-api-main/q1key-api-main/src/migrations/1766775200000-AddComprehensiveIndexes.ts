...
export class AddComprehensiveIndexes1766775200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await this.safeCreateIndex(
      queryRunner,
      "loans",
      "IDX_loans_institution_id",
      '"institution_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "loans",
      "IDX_loans_product_id",
      '"product_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
    ...
    await this.safeCreateIndex(
      queryRunner,
      "loans",
      "IDX_loans_institution_status",
      '"institution_id", "status"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "loans",
      "IDX_loans_branch_status",
      '"branch_id", "status"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "loans",
      "IDX_loans_institution_created_at",
    ...
    await this.safeCreateIndex(
      queryRunner,
      "cash_box_transactions",
      "IDX_cbt_installment_id",
      '"installment_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "cash_box_transactions",
      "IDX_cbt_cashbox_date",
      '"cash_box_id", "created_at" DESC',
    );
    await this.safeCreateIndex(
      queryRunner,
      "cash_box_transactions",
      "IDX_cbt_cashbox_type",
      '"cash_box_id", "transaction_type"',
    );
    ...
    await this.safeCreateIndex(
      queryRunner,
      "cash_boxes",
      "IDX_cashboxes_institution_id",
      '"institution_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "cash_boxes",
      "IDX_cashboxes_branch_id",
      '"branch_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "cash_boxes",
      "IDX_cashboxes_box_type",
      '"box_type"',
    );
    ...
    await this.safeCreateIndex(
      queryRunner,
      "customer_relations",
      "IDX_cr_customer_institution_branch",
      '"customer_id", "institution_id", "branch_id"',
    );
    ...
    await this.safeCreateIndex(
      queryRunner,
      "subscription_requests",
      "IDX_subreq_institution_id",
      '"institution_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "subscription_requests",
      "IDX_subreq_branch_id",
      '"branch_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "subscription_requests",
      "IDX_subreq_requester_type",
      '"requester_type"',
    );
    ...
    await this.safeCreateIndex(
      queryRunner,
      "search_logs",
      "IDX_searchlogs_customer_id",
      '"customer_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "search_logs",
      "IDX_searchlogs_user_id",
      '"user_id"',
    );
    await this.safeCreateIndex(
      queryRunner,
      "search_logs",
      "IDX_searchlogs_created_at",
      '"created_at" DESC',
    );
