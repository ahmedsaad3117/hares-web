...
export class HomePageSettings {
  ...
  @Column({
    name: "hero_title_ar",
    type: "text",
    default: "منصة Q1Key لإدارة القروض",
  })
  heroTitleAr: string;
  ...
  @Column({
    name: "hero_title_en",
    type: "text",
    default: "Q1Key Loan Management Platform",
  })
  heroTitleEn: string;
  ...
  @Column({
    ...
    type: "text",
    default: "الحل الأمثل لإدارة مؤسستك المالية",
  })
  ...
  @Column({
    ...
    type: "text",
    default: "The Ultimate Solution for Managing Your Financial Institution",
  })
  ...
  @Column({
    name: "sections_order",
    type: "text",
    default: '["hero","features","plans","about","contact"]',
  })
